    ...
    return(
        <Container>
            <Row>
                ...
                <p>
                    Perform a search on any word and find out how the people of Twitter feel about it. In a world of biased sources, querying the thoughts of everyday people can lead to interesting insights
                </p>
                </Col>
                <Col md="6" className='columnStyle'>
                <p>
